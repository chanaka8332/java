...
public final class registerBusinessUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t   <select class=\"form-control\" id=\"jobTitle\">\n");
      out.write("                                                                    <option>Contractor</option>\n");
      out.write("                                                                    <option>Architect</option>\n");
      out.write("                                                                    <option>Interior Designer</option>\n");
      out.write("                                                                    <option>Quantity Surveyor</option>\n");
      out.write("                                                                    <option>Architect</option>\n");
      out.write("                                                                    </select>   \n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t<textarea placeholder=\"Enter A Small Description Here..\" rows=\"3\" class=\"form-control\"></textarea>\n");
      out.write("\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\n");
      ...
      out.write("                                                    <button id=\"clear\" class=\"btn btn-default\">Clear</button>\n");
      out.write("                                                </div>\n");
      out.write("                                            </div>\n");
      out.write("                                            \n");
