				...
				<form>
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-4 form-group">
								<label>NIC</label>
								<input type="text" placeholder="Enter National ID Number Here.." class="form-control">
							</div>
                                                    <div class="col-sm-4 form-group">
							...
							<textarea placeholder="Enter A Small Description Here.." rows="3" class="form-control"></textarea>
						</div>	
					<div class="form-group">
